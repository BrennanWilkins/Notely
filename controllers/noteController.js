...
exports.createNote = (req, res, next) => {
  ...
  const note = new Note({ title: req.body.title, body: req.body.body, favorite: false, trash: false,
    dateCreated: req.body.dateCreated, date: req.body.date, userId: req.body.userId, notebookId: req.body.notebookId });
...
exports.updateNote = (req, res, next) => {
  ...
  const note = new Note({ title: req.body.title, body: req.body.body, favorite: req.body.favorite, _id: req.params.id,
    trash: req.body.trash, dateCreated: req.body.dateCreated, date: req.body.date, userId: req.body.userId,
